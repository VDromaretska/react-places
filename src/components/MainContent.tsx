  ...
  return (
    <main className="flex-container">
      <PlaceEntry
        ...
        text={
          "Poveglia Island is an abandoned island located in the Venetian Lagoon in Italy. It has a haunting history and is known as one of the most haunted places in the world."
        }
      />
      <PlaceEntry
        imageURL={"./bran.jpg"}
        ...
        text={
          "Bran Castle, commonly known as Dracula's Castle, is a medieval fortress situated in the Transylvania region of Romania. It has a Gothic appearance and is associated with the legend of Count Dracula."
        }
      />
      <PlaceEntry
        ...
        text={
          "The Island of the Dolls, located in the Xochimilco canals near Mexico City, is adorned with thousands of creepy dolls hanging from trees and buildings. It is believed to be haunted by the spirit of a girl who drowned nearby."
        }
      />
      <PlaceEntry
        imageURL={"./forest.jpg"}
        ...
        text={
          "Aokigahara Forest, also known as the Sea of Trees or Suicide Forest, is a dense forest at the northwest base of Mount Fuji in Japan. It is infamous for its association with suicides and eerie atmosphere."
        }
      />
      <PlaceEntry
        ...
        text={
          "Château de Chillon is a medieval castle located on the shores of Lake Geneva in Switzerland. It has a mysterious atmosphere and is known for its underground dungeons and eerie legends."
        }
      />
    </main>
  );
